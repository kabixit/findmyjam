...
import JammerRegister from './JammerRegister'; // Adjust the import path as per your project structure

const JammerLogin = ({ isOpen, onClose }) => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      navigate('/JamSessions'); // Redirect to jam sessions page after login
    } catch (error) {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      navigate('/JamSessions'); // Redirect to jam sessions page after Google sign-in
    } catch (error) {
      setError(error.message);
  ...
  return (
    <>
      ...
      {/* Registration Modal */}
      <JammerRegister isOpen={showRegisterModal} onClose={() => setShowRegisterModal(false)} />
    </>
  );
};

export default JammerLogin;
